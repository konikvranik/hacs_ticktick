...
class Column(BaseModel):
    ...
    Column
    """
    id: Optional[StrictStr] = Field(default=None, description="The ID of column")
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId", description="The ID of project which column in")
    name: Optional[StrictStr] = Field(default=None, description="Name of column")
    sort_order: Optional[StrictInt] = Field(default=None, alias="sortOrder", description="Order value of column")
